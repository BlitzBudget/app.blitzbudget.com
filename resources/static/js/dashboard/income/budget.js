...
(function scopeWrapper($) {
	...
	function updateBudgetVisualization(createNewChart) {
		...
		if(isNotEmpty(userBudgetCacheKeys)) {
			animateValue(totalBudgetedCategoriesDiv, 0, userBudgetCacheKeys.length, false ,2000);
			...
			if(isNotEmpty(categoryTotalKeys)) {
				...
				animateValue(toBeBudgetedDiv, 0, toBeBudgetedAvailable, false ,2000);				
	...
	$('#budgetAmount').on('click', '.deleteBudget' , function(e) {
		...
		let ajaxData = {};
   		...
   		ajaxData.url = CUSTOM_DASHBOARD_CONSTANTS.budgetAPIUrl + currentUser.financialPortfolioId + '/' + categoryId + CUSTOM_DASHBOARD_CONSTANTS.dateMeantFor + chosenDate + CUSTOM_DASHBOARD_CONSTANTS.deleteOnlyAutoGeneratedFalseParam;
	...
	$('#budgetAmount').on('click', '#copyPreviousMonthsBudget' , function(e) {
		...
		let ajaxData = {};
   		ajaxData.isAjaxReq = true;
   		ajaxData.type = "POST";
   		ajaxData.url = CUSTOM_DASHBOARD_CONSTANTS.budgetAPIUrl + CUSTOM_DASHBOARD_CONSTANTS.budgetCopyBudgetUrl + currentUser.financialPortfolioId;
   		ajaxData.dataType = "json";
   		ajaxData.contentType = "application/x-www-form-urlencoded; charset=UTF-8";
   		ajaxData.values = values;
	...
	function fetchAllDatesWithUserBudgetData() {
		...
		let ajaxData = {};
   		ajaxData.isAjaxReq = true;
   		ajaxData.type = 'GET';
   		ajaxData.url = CUSTOM_DASHBOARD_CONSTANTS.budgetAPIUrl + CUSTOM_DASHBOARD_CONSTANTS.budgetFetchAllDates + currentUser.financialPortfolioId;
	...
	$( "#budgetAmount" ).on( "change", ".categoryOptions" ,function() {
		...
		let ajaxData = {};
   		ajaxData.isAjaxReq = true;
   		ajaxData.type = "POST";
   		ajaxData.url = CUSTOM_DASHBOARD_CONSTANTS.budgetAPIUrl + CUSTOM_DASHBOARD_CONSTANTS.changeBudgetUrl + currentUser.financialPortfolioId;
   		ajaxData.dataType = "json";
   		ajaxData.contentType = "application/x-www-form-urlencoded; charset=UTF-8";
   		ajaxData.values = values;
   		ajaxData.onSuccess = function(userBudget){
