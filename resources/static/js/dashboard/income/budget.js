...
(function scopeWrapper($) {
	...
	function fetchTransactions() {
		jQuery.ajax({
			url: CUSTOM_DASHBOARD_CONSTANTS.transactionAPIUrl + CUSTOM_DASHBOARD_CONSTANTS.transactionFetchCategoryTotal + currentUser.walletId + CUSTOM_DASHBOARD_CONSTANTS.dateMeantFor + chosenDate.toISOString() + CUSTOM_DASHBOARD_CONSTANTS.updateBudgetFalseParam,
			beforeSend: function(xhr){xhr.setRequestHeader("Authorization", authHeader);},
            type: 'GET',
	...
	$('#budgetAmount').on('click', '.deleteBudget' , function(e) {
		...
		let ajaxData = {};
   		...
   		ajaxData.url = CUSTOM_DASHBOARD_CONSTANTS.budgetAPIUrl + currentUser.walletId + '/' + categoryId + CUSTOM_DASHBOARD_CONSTANTS.dateMeantFor + chosenDate.toISOString() + CUSTOM_DASHBOARD_CONSTANTS.deleteOnlyAutoGeneratedFalseParam;
   		ajaxData.contentType = "application/json; charset=utf-8";
