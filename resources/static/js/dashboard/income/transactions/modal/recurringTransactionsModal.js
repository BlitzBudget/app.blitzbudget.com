...
(function scopeWrapper ($) {
  $('body').on('click', '#futureTransactionsTable .recurTransEntry', function (e) {
    ...
    /*
         * Delete all tags
         */
    const editTagsChosen = document.querySelectorAll('#edit-recurring-transaction-tags .badge')
    // Tags Chosen
    ...
    const recurringTransactionsId = this.dataset.target
    const currentRecurringTrans = window.recurringTransactionCache[recurringTransactionsId]
    const categoryId = currentRecurringTrans.category
    ...
    const creationDateUserRelevant = new Date(currentRecurringTrans.creation_date)
  ...
  $('body').on('click', '#deleteSvgRecurringTransactions', function (e) {
    const recurringTransactionId = document.getElementById('recurringTransactionInformationMdl').dataset.target
    // Click the close button
    document.getElementById('recurringTransactionHeaderClose').click()
    // Remove transactions
    const recurTransaction = document.getElementById('recurTransaction-' + recurringTransactionId)
    ...
    ajaxData.onSuccess = function (jsonObj) {
      ...
      const recurrenceValue = window.recurringTransactionCache[recurringTransactionId].recurrence
      const recurrenceValueEl = document.getElementById('recurTransSB-' + recurrenceValue)
      const recurrenceValueEntry = recurrenceValueEl.getElementsByClassName('recentTransactionEntry')
  ...
  $('body').on('keyup', '#recurringTransactionTagsEntry', function (e) {
    ...
    if (isEqual(keyCode, 'Enter')) {
      ...
      /*
             * Tags Array update
             */
      const tagsChosen = document.querySelectorAll('#edit-recurring-transaction-tags .badge')
      const tagsArray = []
  ...
  $('body').on('keyup', '#recurringTransactionDescriptionEntry', function (e) {
    ...
    if (isEqual(keyCode, 'Enter')) {
      ...
      /*
             ...
             */
      const recurringTransactionDescriptionEntry = document.getElementById('recurringTransactionDescriptionEntry')
      ...
      /*
             ...
             */
      const recurTransEl = document.getElementById('recurTransaction-' + recurringTransactionId)
      const recurTransDescEl = recurTransEl.getElementsByClassName('recentTransactionDescription')
  ...
  $('body').on('keyup', '#recurringTransactionAmountEntry', function (e) {
    ...
    if (isEqual(keyCode, 'Enter')) {
      ...
      /*
             ...
             */
      const recurringTransactionAmountEntry = document.getElementById('recurringTransactionAmountEntry')
      ...
      /*
             ...
             */
      const recurTransEl = document.getElementById('recurTransaction-' + recurringTransactionId)
      const transactionAmountRT = recurTransEl.getElementsByClassName('transactionAmountRT')
