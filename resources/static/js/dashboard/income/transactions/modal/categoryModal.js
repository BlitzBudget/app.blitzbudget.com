...
(function scopeWrapper ($) {
  ...
  $('body').on('click', '.categoryInfoTable .categorySortGrp', function (e) {
    // Account modal id
    const categoryInfoTable = this.closest('.categoryInfoTable')
    const categoryId = categoryInfoTable.getAttribute('data-target')
    // Current Selected Category ID
    currentCategoryId = categoryId
    // Fetch the total number of transactions for the account
    const recentTransactionEntry = categoryInfoTable.getElementsByClassName('recentTransactionEntry')
    // Set the number of transactions if present
    const numberOfTransactionsDiv = document.getElementById('numberOfTransInCat')
    ...
    // Open Category Modal
    const categoryInformationMdl = document.getElementById('categoryInformationMdl')
    ...
    const amountAccumulatedCat = document.getElementById('amountAccumulatedCat')
