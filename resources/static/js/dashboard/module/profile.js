...
(function scopeWrapper ($) {
  ...
  const profilePgDD = document.getElementById('profilePgDD')
  ...
  function populateCurrentPage (page) {
    ...
    er.fetchCurrentPage('/profile', function (data) {
      ...
      const featureRequest = document.getElementById('sendFeatureRequest')
  ...
  function displayCreatedDate () {
    ...
    ajaxData.onSuccess = function (result) {
      const userCreationDate = result.UserCreateDate
    ...
    ajaxData.onFailure = function (thrownError) {
      const createddateerror = isNotEmpty(window.translationData) ? window.translationData.profile.dynamic.createerror : 'There was an error while fetching user information!'
  ...
  function displayUserDetailsProfile () {
    // User Name
    const userName = currentUser.name + ' ' + currentUser.family_name
  ...
  $(document).on('keyup', '#oldPasswordCP', function (e) {
    ...
    const newPassword = document.getElementById('newPassCP').value
    const changePassBtn = document.getElementsByClassName('swal2-confirm')[0]
  ...
  $(document).on('focusout', '#oldPasswordCP', function () {
    const oldPassword = this.value
    const errorCPOld = document.getElementById('cpErrorDispOld')
    const errorCPNew = document.getElementById('cpErrorDispNew')
  ...
  $(document).on('keyup', '#newPassCP', function (e) {
    const newPassword = this.value
    const oldPasswordCP = document.getElementById('oldPasswordCP').value
    const changePassBtn = document.getElementsByClassName('swal2-confirm')[0]
  ...
  function changePasswordFrag () {
    const changePassFrag = document.createDocumentFragment()
    ...
    // New Password
    const newPassInput = document.createElement('div')
    ...
    const dropdownGroupNP = document.createElement('div')
    dropdownGroupNP.classList = 'btn-group d-md-block d-block'

    const newPassNameInput = document.createElement('input')
    ...
    const dropdownTriggerNP = document.createElement('button')
    ...
    const miEyeNP = document.createElement('i')
    ...
    // Error Text
    const errorCP = document.createElement('div')
    ...
    Swal.fire({
      ...
      preConfirm: () => {
        return new Promise(function (resolve) {
          const confPasswordUA = document.getElementById('oldPasswordCP')
      ...
      const newPassword = document.getElementById('newPassCP').value
      const oldPassword = document.getElementById('oldPasswordCP').value
  ...
  $('body').on('click', '#deleteBBAccount', function (e) {
    Swal.fire({
      ...
      preConfirm: () => {
        return new Promise(function (resolve) {
          const confPasswordUA = document.getElementById('oldPasswordDA')
          // Authentication Details
          const values = {}
          values.username = currentUser.email
          values.password = confPasswordUA.value
    ...
    // Disable Change Password button
    const deleteBBBtn = document.getElementsByClassName('swal2-confirm')[0]
  ...
  $(document).on('keyup', '#oldPasswordRP', function (e) {
    const resetAccountBtn = document.getElementsByClassName('swal2-confirm')[0]
    const errorDispRA = document.getElementById('cpErrorDispOldRA')
    const passwordEnt = this.value
  ...
  function deleteBBAccount () {
    const deletePassFrag = document.createDocumentFragment()
  ...
  $(document).on('keyup', '#oldPasswordDA', function (e) {
    const deleteAccountBtn = document.getElementsByClassName('swal2-confirm')[0]
    const errorDispRA = document.getElementById('cpErrorDispOldDA')
    const passwordEnt = this.value
  ...
  $('body').on('click', '#userNameEdit', function (e) {
    ...
    // Name
    const userNameProfileDisplay = document.getElementById('userNameProfileDisplay').classList
    userNameProfileDisplay.add('d-none')
    // Change the User Name
    const userNameModInp = document.getElementById('userNameModInp')
    userNameModInp.value = currentUser.name + ' ' + currentUser.family_name
    // Display Edit Form
    const userNameEditProf = document.getElementById('userNameEditProf')
  ...
  function editUserDetailsFNAndLN () {
    ...
    const userNameModInp = document.getElementById('userNameModInp').value
    const userNameLis = splitElement(userNameModInp, ' ')
  ...
  function confirmPasswordFrag () {
    const confPassFrag = document.createDocumentFragment()
  ...
  function updateUserName (firstName, lastName) {
    const userNameProfileDisplay = document.getElementById('userNameProfileDisplay')
    const userNameDispText = userNameProfileDisplay.textContent
  ...
  $(document).on('keyup', '#confPasswordUA', function (e) {
    const confirmPassBtn = document.getElementsByClassName('swal2-confirm')[0]
    const cpErrorDispUA = document.getElementById('cpErrorDispUA')
    const passwordEnt = this.value
  ...
  $('body').on('click', '#emailEdit', function (e) {
    ...
    this.classList.add('d-none')
    // Name
    const emailProfileDisplay = document.getElementById('emailProfileDisplay').classList
    emailProfileDisplay.add('d-none')
    // Change the User Name
    const emailModInp = document.getElementById('emailModInp')
    emailModInp.value = currentUser.email
    // Display Edit Form
    const emailEditProf = document.getElementById('emailEditProf')
  ...
  function editUserDetailsEmail () {
    ...
    // Update First Name and Last Name
    const emailModInp = document.getElementById('emailModInp').value
    ...
    Swal.fire({
      ...
      preConfirm: () => {
        return new Promise(function (resolve) {
          // Hide the validation message if present
          Swal.resetValidationMessage()
          const confPasswordUA = document.getElementById('confPasswordUA')
          // Authentication Details
          const values = {}
          values.username = currentUser.email
          values.password = confPasswordUA.value
      ...
      // Hide the validation message if present
      Swal.resetValidationMessage()
      const confPasswordUA = document.getElementById('confPasswordUA').value
      // If confirm button is clicked
      if (result.value) {
        // Update User Email
    ...
    Swal.fire({
      ...
      preConfirm: () => {
        return new Promise(function (resolve) {
          // Hide the validation message if present
          Swal.resetValidationMessage()
          const verificationCode = document.getElementsByClassName('swal2-input')[0]
