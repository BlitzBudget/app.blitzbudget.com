	...
	updateBudget(async) {
		if(isNotEmpty(updateBudgetMap)) {
			...
			let ajaxData = {};
	   		ajaxData.isAjaxReq = true;
	   		ajaxData.type = 'POST';
	   		ajaxData.url = CUSTOM_DASHBOARD_CONSTANTS.budgetAPIUrl + currentUser.financialPortfolioId + CUSTOM_DASHBOARD_CONSTANTS.budgetAutoGeneratedUpdateUrl + chosenDate;
	   		ajaxData.dataType = "json"; 
