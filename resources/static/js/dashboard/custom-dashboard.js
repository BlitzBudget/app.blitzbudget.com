	...
	$(document).ready(function(){
		...
		function fetchIncomeTotalOrExpeseTotal(incomeTotalParameter) {
			...
			let ajaxData = {};
	   		...
	   		ajaxData.type = 'GET';
	   		ajaxData.url = CUSTOM_DASHBOARD_CONSTANTS.overviewUrl + CUSTOM_DASHBOARD_CONSTANTS.lifetimeUrl + incomeTotalParameter + CUSTOM_DASHBOARD_CONSTANTS.financialPortfolioId + currentUser.walletId;
	...
	updateBudget(async) {
		if(isNotEmpty(updateBudgetMap)) {
			...
			let ajaxData = {};
	   		ajaxData.isAjaxReq = true;
	   		ajaxData.type = 'POST';
	   		ajaxData.url = CUSTOM_DASHBOARD_CONSTANTS.budgetAPIUrl + currentUser.walletId + CUSTOM_DASHBOARD_CONSTANTS.budgetAutoGeneratedUpdateUrl + chosenDate;
	   		ajaxData.dataType = "json"; 
	   		ajaxData.contentType = "application/json;charset=UTF-8";
	   		ajaxData.data = JSON.stringify(updateBudgetMap);
	   		ajaxData.onSuccess = function(result){
