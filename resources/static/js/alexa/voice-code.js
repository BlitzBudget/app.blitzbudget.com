...
(function scopeWrapper ($) {
  ...
  const voiceCodeEl = document.getElementById('voice-code')
  // Email Element on focus
  const emailEl = document.getElementById('email')
  const saveButtonEl = document.getElementById('saveButton')
  const continueButtonEl = document.getElementById('continueButton')
  const nextButtonEl = document.getElementById('nextButton')
  const voiceCodeBoxEl = document.getElementById('voice-code-box')
  const emailBoxEl = document.getElementById('email-box')
  const passwordBoxEl = document.getElementById('password-box')
  const optOutOfVoiceCode = document.getElementById('opt-out-voice-code')
  const changeVoiceCode = document.getElementById('change-voice-code')
  const forgotPasswordAnchor = document.getElementById('forgot-password')
  const materialSpinnerLoading = document.getElementById('material-spinner-loading')
  ...
  document.getElementById('password').addEventListener('keyup', function (e) {
    const keyPressed = e.key
    const errorPassword = document.getElementById('error-password-length')
  ...
  saveButtonEl.addEventListener('click', function () {
    ...
    ajaxData.onFailure = function (thrownError) {
      const responseJson = thrownError.responseJSON
      if (isNotEmpty(responseJson)) {
        const message = isNotEmpty(responseJson.errorMessage) ? responseJson.errorMessage : responseJson.message
